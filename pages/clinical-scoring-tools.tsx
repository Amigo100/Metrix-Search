      ...
      <div className="w-full">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-md border ${
                selectedCalcType === option
                  ? 'bg-[#008080] text-white border-[#008080]-600'
                  : 'bg-white text-gray-700 border-gray-300 hover:bg-[#008080]-50'
              } transition-colors`}
            >
              {option}
            </button>
                ...
                Object.keys(filteredCategorizedTools).map((category) => (
                  <div key={category}>
                    ...
                    {filteredCategorizedTools[category].map((tool) => (
                      <div
                        key={tool.name}
                        className="px-3 py-2 hover:bg-[#008080]-50 cursor-pointer text-gray-700"
        ...
        {selectedTool && (
          <div className="bg-white shadow-md rounded-lg p-6 mx-auto w-full max-w-4xl">
            <h2 className="text-xl font-semibold text-[#008080]-700 mb-2 text-center">
              {selectedTool.name}
            </h2>
                  ...
                  return (
                    ...
                    >
                      ...
                      <input
                        type="number"
                        id={field.key}
                        className="mt-1 sm:mt-0 border border-gray-300 p-2 rounded-md w-full sm:w-40 focus:ring-[#008080]-400 focus:outline-none"
                ...
                if (field.type === 'select') {
                  return (
                    ...
                    >
                      ...
                      <select
                        id={field.key}
                        className="mt-1 sm:mt-0 border border-gray-300 p-2 rounded-md w-full sm:w-60 focus:ring-[#008080]-400 focus:outline-none"
                        value={formValues[field.key] || ''}
                        onChange={(e) => handleFieldChange(field.key, e.target.value)}
                      >
            ...
            <button
              ...
              className="mt-6 bg-[#008080]-600 text-white px-6 py-2 rounded-md hover:bg-[#008080]-700 transition-colors"
            >
              Calculate
            </button>

            {scoreResult && (
              <div className="mt-6 p-4 border-l-4 border-[#008080]-600 bg-[#008080]-50 rounded-md">
                <h3 className="font-semibold text-[#008080]-700 text-lg">Result</h3>
              ...
              <div className="mt-6 flex gap-3 justify-center">
                {selectedTool.nextSteps && (
                  <button
                    ...
                    className="bg-[#008080]-600 text-white px-4 py-2 rounded-md hover:bg-[#008080]-700"
                  >
            ...
            {showNextSteps && selectedTool.nextSteps && (
              <div className="mt-4 p-4 border rounded bg-gray-50">
                <h4 className="text-md font-semibold text-[#008080]-700 mb-2">Next Steps</h4>
                <div className="mb-3">
            ...
            {showEvidence && selectedTool.evidence && (
              <div className="mt-4 p-4 border rounded bg-gray-50">
                <h4 className="text-md font-semibold text-[#008080]-700 mb-2">
                  Evidence & References
                </h4>
