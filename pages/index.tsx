    ...
    <>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-start">
                  <div className="text-center animate-fadeInUp delay-200">
                    <img src="/images/local-network.png" alt="Local Network Security" width={400} height={300} className="rounded-2xl shadow-xl mx-auto mb-8 border border-gray-200 w-full max-w-sm object-cover" onError={(e) => { const target = e.target as HTMLImageElement; target.onerror = null; target.src='/images/placeholder-400x300.png';}}/>
                  ...
                  <div className="text-center animate-fadeInUp delay-400">
                    <img src="/images/offline-capability.png" alt="Offline capability graphic" width={400} height={300} className="rounded-2xl shadow-xl mx-auto mb-8 border border-gray-200 w-full max-w-sm object-cover" onError={(e) => { const target = e.target as HTMLImageElement; target.onerror = null; target.src='/images/placeholder-400x300.png';}}/>
      ...
      <section className="py-20 sm:py-28 lg:py-32 bg-gradient-to-b from-teal-50 to-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                  <TestimonialCard delay="delay-200" quote="Metrix's on-site model was crucial for us. The AI scribe is excellent, and having integrated calculators and guideline search saves significant time during busy shifts." name="Dr. Aisha Khan" title="Emergency Medicine Consultant, UK" avatarSrc="/images/avatars/avatar-1.jpg" rating={5} />
                  <TestimonialCard delay="delay-300" quote="The predictive insights for ED wait times have been surprisingly accurate, helping us manage patient flow more effectively. The chatbot is great for quick lookups." name="Mr. David Chen" title="Hospital Operations Manager, NZ" avatarSrc="/images/avatars/avatar-2.jpg" rating={4} />
                  <TestimonialCard delay="delay-400" quote="As clinicians ourselves, the Metrix team understands the nuances of our workflow. The ability to search local guidelines securely is a feature we've needed for years." name="Dr. Olivia Wells" title="General Practitioner, UK" avatarSrc="/images/avatars/avatar-3.jpg" rating={5} />
              </div>
          </div>
      </section>
